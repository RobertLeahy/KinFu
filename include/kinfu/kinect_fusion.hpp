...
namespace kinfu {
	...
	class kinect_fusion {
		...
		public:
			 ...
			 *	benchmarking.
			 */
			using timer=kinfu::timer;
		
		
		private:
		
		
			kinfu::depth_device * dd_;
			timer::duration ddt_;
			Eigen::Matrix3f k_;
			std::size_t width_;
			std::size_t height_;
			kinfu::measurement_pipeline_block * mpb_;
			timer::duration mpbt_;
			kinfu::pose_estimation_pipeline_block * pepb_;
			timer::duration pepbt_;
			kinfu::update_reconstruction_pipeline_block * urpb_;
			timer::duration urpbt_;
			kinfu::surface_prediction_pipeline_block * sppb_;
			timer::duration sppbt_;
			kinfu::depth_device::value_type frame_;
			kinfu::measurement_pipeline_block::value_type map_;
			kinfu::pose_estimation_pipeline_block::value_type t_g_k_;
			kinfu::update_reconstruction_pipeline_block::value_type tsdf_;
			kinfu::surface_prediction_pipeline_block::value_type prev_map_;
		...
		public:
			 ...
			 */
			void depth_device (kinfu::depth_device & dd) noexcept;
			/**
			 ...
			 */
			void measurement_pipeline_block (kinfu::measurement_pipeline_block & mpb) noexcept;
			/**
			 ...
			 *		object is in use or the behaviour is undefined.
			 */
			void pose_estimation_pipeline_block (kinfu::pose_estimation_pipeline_block & pepb) noexcept;
			/**
			 ...
			 *		undefined.
			 */
			void update_reconstruction_pipeline_block (kinfu::update_reconstruction_pipeline_block & urpb) noexcept;
			/**
			 ...
			 *		undefined.
			 */
			void surface_prediction_pipeline_block (kinfu::surface_prediction_pipeline_block & sppb) noexcept;
			 ...
			 */
			kinfu::depth_device::value_type::element_type & frame () const noexcept;
			/**
			 ...
			 */
			kinfu::measurement_pipeline_block::value_type::element_type & vertex_and_normal_map () const noexcept;
			/**
			 ...
			 */
			kinfu::pose_estimation_pipeline_block::value_type::element_type & pose_estimation () const noexcept;
			/**
			 ...
			 */
			kinfu::update_reconstruction_pipeline_block::value_type::element_type & truncated_signed_distance_function () const noexcept;
			/**
			 ...
			 */
			kinfu::surface_prediction_pipeline_block::value_type::element_type & predicted_vertex_and_normal_map () const noexcept;
